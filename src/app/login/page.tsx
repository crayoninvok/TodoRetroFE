        ...
        <div className="gradient-border">
          <div className="card">
            <div className="text-center mb-8 animate-slide-up">
              ...
              <p className="text-light-gray">Welcome back to Spektra</p>
            </div>
            ...
            >
              <button className="flex justify-center items-center gap-2 px-4 py-3 border border-white/10 rounded-md hover:bg-white/5 transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
